...
# from adapter-transformers import special class AutoModelWithHeads
...
# transformers.utils didn't have get_full_repo_name module, maybe removed from previous version?
...
def main():
    ...
    # If you wanna show some random samples from the training set...
    ...
    pgd = PGD(model, emb_name='word_embeddings', epsilon=1.0, alpha=0.3, K=3)
    K = pgd.K
    print(f"Adversarial training by PGD. Datasets: {args.task_name.upper()}")
