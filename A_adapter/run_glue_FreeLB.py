...
def main():
    ...
    test_loss = []
    # set freeLb
    freelb = FreeLB(adv_K=3, adv_lr=1e-1, adv_init_mag=2e-2, adv_max_norm=1.0, adv_norm_type='l2', base_model='bert')
    print(f"Adversarial training by FreeLB. Datasets: {args.task_name.upper()}")
